...
from setup_eval.inspection.registry import get_all_rules, suggest_rule_id
from setup_eval.inspection.suppression import is_suppressed, parse_suppressions
...
def lint_mcp_config(
    ...
    from setup_eval.utils.tokens import count_tokens
